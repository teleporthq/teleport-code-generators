            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.plugins.reduce(function (previousPluginOperation, plugin) { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    case 1:
                        finalStructure = _a.sent();
                        externalDependencies = utils_1.extractExternalDependencies(finalStructure.dependencies);
                        chunks = utils_1.groupChunksByFileId(finalStructure.chunks);
                        return [2 /*return*/, {
                                chunks: chunks,
