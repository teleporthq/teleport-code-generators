// @ts-ignore-next-line
import ComponentWithValidJSON from './component-with-valid-style.json.js'
// @ts-ignore-next-line
import ComponentWithNestedStyles from './component-with-nested-styles.json.js'
// @ts-ignore-next-line
import ComponentWithInvalidStateStyles from './component-with-invalid-state-styles.json.js'
// @ts-ignore-next-line
import ComponentWithValidSingleStlye from './component-with-valid-single-prop-style.json.js'
// @ts-ignore-next-line
import ComponentWithNestedMultiplePropRef from './component-with-nested-multiple-prop-ref-styles.json.js'
// @ts-ignore-next-line
import ComponentWithNestedSinglePropRef from './component-with-nested-single-prop-ref-styles.json.js'
// @ts-ignore-next-line
import ComponentWithStateReference from './component-with-valid-state-reference.json.js'
