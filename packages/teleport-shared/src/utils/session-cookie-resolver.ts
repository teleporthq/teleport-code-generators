 ...
 * from this one definition. It lives in teleport-shared because both the
 * workflow routes and the per-table data routes decode the session.
 */
...
// @teleporthq/teleport-shared/src/utils/session-cookie-resolver.ts.
//
