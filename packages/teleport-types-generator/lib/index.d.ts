...
export declare type ChunkContent = string | any | any[]
/**
...
export declare type ComponentPlugin = (structure: ComponentStructure) => Promise<ComponentStructure>
export interface ComponentDefaultPluginParams {
  fileId: string
}
export declare type ComponentPluginFactory<T> = (
...
export declare type CodeGeneratorFunction<T> = (content: T) => string
/**
...
export declare type ProjectGeneratorFunction = (
  uidl: ProjectUIDL,
 ...
 */
export declare type AttributeAssignCodeMod<T> = (
  generatedEntity: T,
  attributeKey: string,
 ...
 */
export declare type NodeSyntaxGenerator<Accumulators, ReturnValues> = (
  node: UIDLNode,
...
export declare type GenerateProjectFunction = (
  input: Record<string, unknown>,
  options: ProjectGeneratorOptions
) => Promise<ProjectGeneratorOutput>
export declare type GenerateComponentFunction = (
  input: Record<string, unknown>,
