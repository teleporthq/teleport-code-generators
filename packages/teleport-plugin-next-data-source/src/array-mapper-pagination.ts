...
/**
 * @deprecated Not part of the generation pipeline.
 *
 * Array-mapper pagination is generated by `pagination-plugin.ts` (with
 * `numbered-pagination.ts`, `infinite-scroll.ts` and `pagination-controls.ts`).
 * This module models an older client-side slicing design and is kept only
 * because it is re-exported from the package index; nothing in the pipeline
 * calls it. Add nothing here — the two would drift apart in silence.
 */
