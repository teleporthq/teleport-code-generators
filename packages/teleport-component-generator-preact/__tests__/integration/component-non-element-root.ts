// @ts-ignore
import ComponentWithConditionalRootStringNode from './component-with-conditional-root-string-child-node.json.js'
// @ts-ignore
import ComponentWithConditionalRootArrayNode from './component-with-conditional-root-array-child-node.json.js'
