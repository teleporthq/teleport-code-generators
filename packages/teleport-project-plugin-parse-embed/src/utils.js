...
// http-url:https://cdn.skypack.dev/-/entities@v4.4.0-jJU5zArSVTzLNa6pZTX7/dist=es2019,mode=imports/optimized/entities/lib/decode.js
...
var xmlDecodeTree = new Uint16Array("\u0200aglq	\x1B\u026D\0\0p;\u4026os;\u4027t;\u403Et;\u403Cuot;\u4022".split("").map((c) => c.charCodeAt(0)));
var _a;
...
// http-url:https://cdn.skypack.dev/-/entities@v4.4.0-jJU5zArSVTzLNa6pZTX7/dist=es2019,mode=imports/optimized/entities/lib/escape.js
...
// http-url:https://cdn.skypack.dev/-/parse5@v7.1.2-1n9jFnyCXP9ZR0A0HyTC/dist=es2019,mode=imports/optimized/parse5.js
...
var FormattingElementList = class {
  ...
  insertElementAfterBookmark(element3, token2) {
...
var Parser = class {
  ...
  static parse(html22, options) {
    const parser = new this(options);
    parser.tokenizer.write(html22, true);
  ...
  _appendElement(token2, namespaceURI) {
    const element3 = this.treeAdapter.createElement(token2.tagName, namespaceURI, token2.attrs);
    this._attachElementToTree(element3, token2.location);
  }
  _insertElement(token2, namespaceURI) {
    const element3 = this.treeAdapter.createElement(token2.tagName, namespaceURI, token2.attrs);
    this._attachElementToTree(element3, token2.location);
    this.openElements.push(element3, token2.tagID);
  }
...
function parse(html22, options) {
  return Parser.parse(html22, options);
}
function parseFragment(fragmentContext, html22, options) {
  if (typeof fragmentContext === "string") {
    options = html22;
    html22 = fragmentContext;
...
// http-url:https://cdn.skypack.dev/-/is-buffer@v2.0.5-pEqX5mY5KE8OTGseAfDW/dist=es2019,mode=imports/optimized/is-buffer.js
var isBuffer = function isBuffer2(obj) {
  return obj != null && obj.constructor != null && typeof obj.constructor.isBuffer === "function" && obj.constructor.isBuffer(obj);
};
var is_buffer_default = isBuffer;

// http-url:https://cdn.skypack.dev/-/unist-util-stringify-position@v3.0.2-lVT7gFNGzZozB32mCZIA/dist=es2019,mode=imports/optimized/unist-util-stringify-position.js
...
function point(point22) {
  return index(point22 && point22.line) + ":" + index(point22 && point22.column);
}
...
// http-url:https://cdn.skypack.dev/-/vfile-message@v3.1.3-54Bho5a6cKuCJgmBQQi0/dist=es2019,mode=imports/optimized/vfile-message.js
...
// http-url:https://cdn.skypack.dev/-/vfile@v5.3.6-gIzjgJGFBP4n28CaaDZR/dist=es2019,mode=imports/optimized/vfile.js
...
// http-url:https://cdn.skypack.dev/-/property-information@v6.2.0-X0c4T9A2e2hAgvXGrug1/dist=es2019,mode=imports/optimized/property-information.js
var Schema = class {
...
// http-url:https://cdn.skypack.dev/-/hast-util-parse-selector@v3.1.1-lgD1czE2XLSD6kbyRTCg/dist=es2019,mode=imports/optimized/hast-util-parse-selector.js
var search = /[#.]/g;
...
// http-url:https://cdn.skypack.dev/-/space-separated-tokens@v2.0.2-kNfE5VxGdQGWdCzMCQIT/dist=es2019,mode=imports/optimized/space-separated-tokens.js
...
// http-url:https://cdn.skypack.dev/-/comma-separated-tokens@v2.0.3-7MRZBDcWRF9yz8L3tZpd/dist=es2019,mode=imports/optimized/comma-separated-tokens.js
...
// http-url:https://cdn.skypack.dev/-/hastscript@v7.2.0-Z0PotN4aeVOuFyP2vEOZ/dist=es2019,mode=imports/optimized/common/core-124d8a8d.js
...
// http-url:https://cdn.skypack.dev/-/hastscript@v7.2.0-Z0PotN4aeVOuFyP2vEOZ/dist=es2019,mode=imports/optimized/common/html-43e6da38.js
var h = core(html$1, "div");

// http-url:https://cdn.skypack.dev/-/hastscript@v7.2.0-Z0PotN4aeVOuFyP2vEOZ/dist=es2019,mode=imports/optimized/common/svg-44400851.js
...
var s = core(svg$1, "g", svgCaseSensitiveTagNames);

// http-url:https://cdn.skypack.dev/-/vfile-location@v4.0.1-o6m8xsdQkyv2fl65FC0t/dist=es2019,mode=imports/optimized/vfile-location.js
...
// http-url:https://cdn.skypack.dev/-/web-namespaces@v2.0.1-tm9VHc94fl1dHOqTM8xL/dist=es2019,mode=imports/optimized/web-namespaces.js
var webNamespaces = {
...
// http-url:https://cdn.skypack.dev/-/hast-util-from-parse5@v7.1.1-dMB2RRYqPq4ofGznB5UK/dist=es2019,mode=imports/optimized/hast-util-from-parse5.js
...
function element(state, node) {
  ...
  state.schema = node.namespaceURI === webNamespaces.svg ? svg$1 : html$1;
  let index2 = -1;
  const props = {};
...
function patch(state, from, to) {
  if ("sourceCodeLocation" in from && from.sourceCodeLocation && state.file) {
    const position22 = createLocation(state, to, from.sourceCodeLocation);
    if (position22) {
      state.location = true;
      to.position = position22;
    }
  }
}
      ...
      if (location2.attrs) {
        for (key2 in location2.attrs) {
          if (own3.call(location2.attrs, key2)) {
            props[find(state.schema, key2).property] = position2(location2.attrs[key2]);
          }
        }
      }
      node.data = {
...
function point2(point22) {
  return point22.line && point22.column ? point22 : void 0;
}
function isFile(value) {
  return "messages" in value;
}

// http-url:https://cdn.skypack.dev/-/hast-util-from-html@v1.0.1-5JwtbeoTNndAh4z874nd/dist=es2019,mode=imports/optimized/hast-util-from-html.js
var errors = {
...
function fromHtml(value, options) {
  ...
  function onerror(error) {
    ...
    function format(value2) {
      return value2.replace(/%c(?:([-+])(\d+))?/g, (_, $1, $2) => {
...
// http-url:https://cdn.skypack.dev/-/html-void-elements@v2.0.1-irrPCSoExs9HDrapgYgY/dist=es2019,mode=imports/optimized/html-void-elements.js
...
// http-url:https://cdn.skypack.dev/-/zwitch@v2.0.4-5rayHHtyZDwjNphPbA2N/dist=es2019,mode=imports/optimized/zwitch.js
...
// http-url:https://cdn.skypack.dev/-/character-entities-legacy@v3.0.0-HNSYGCzdqcanOB7OUvkv/dist=es2019,mode=imports/optimized/character-entities-legacy.js
...
// http-url:https://cdn.skypack.dev/-/character-entities-html4@v2.1.0-q0SJ6ekFaeE6PokcISsy/dist=es2019,mode=imports/optimized/character-entities-html4.js
...
// http-url:https://cdn.skypack.dev/-/stringify-entities@v4.0.3-J33m2g4dwqDTFUcYA9pS/dist=es2019,mode=imports/optimized/stringify-entities.js
...
// http-url:https://cdn.skypack.dev/-/ccount@v2.0.1-MVFJa0zx2WNFfBo6MWcK/dist=es2019,mode=imports/optimized/ccount.js
...
// http-url:https://cdn.skypack.dev/-/hast-util-whitespace@v2.0.1-jKAK32mdfgsTZeZPKHPA/dist=es2019,mode=imports/optimized/hast-util-whitespace.js
function whitespace(thing) {
  const value = thing && typeof thing === "object" && thing.type === "text" ? thing.value || "" : thing;
  return typeof value === "string" && value.replace(/[ \t\n\f\r]/g, "") === "";
}

// http-url:https://cdn.skypack.dev/-/hast-util-to-html@v8.0.4-ViQm0Bjn0JO11OWKbEWF/dist=es2019,mode=imports/optimized/hast-util-to-html.js
...
function html2(_, index2, parent) {
...
function toHtml(tree, options) {
  ...
  const state = {
    ...
    schema: options_.space === "svg" ? svg$1 : html$1,
    quote,
    alternative
  };
